...
class CheckBoxPage(BasePage):
    ...
    def get_checkbox(self):
        ...
        for box in checked_list:
            title_item = box.find_elements(By.XPATH, self.locators.TITLE_ITEMS)
...
class RadioButtonPage(BasePage):
    ...
    def click_on_the_radio_button(self, choice):
        choices = {'yes': self.locators.YES_RADIOBUTTON,
                   'impres': self.locators.IMPRESS_RADIOBUTTON,
                   'no': self.locators.NO_RADIOBUTTON}
        self.element_is_visible(choices[choice]).click()

        # self.element_is_visible(choice[choices]).click()
...
class DynamicPropertiesPage(BasePage):
    ...
    def check_enable_button(self):
        try:
            self.element_is_clickable(self.locators.ENABLE_BUTTON).click()
    ...
    def check_appear_button(self):
        try:
            self.element_is_visible(self.locators.VISIBLE_AFTER_FIVE)
        except TimeoutException:
            return False
        return True
